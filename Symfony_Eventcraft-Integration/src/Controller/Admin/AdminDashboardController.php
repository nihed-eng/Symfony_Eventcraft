...
public function fullList(SalleRepository $salleRepository): HttpResponse
{
    ...
    public function respondToReclamation(Reclamation $reclamation, Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        // Create new response if none exists, or update existing
        $response = $reclamation->getResponse() ?? new Response();
