...
class AdminDashboardController extends AbstractController
{
    ...
    public function fullList(SalleRepository $salleRepository): Response
    {
...
public function new(Request $request, EntityManagerInterface $entityManager, SluggerInterface $slugger): Response
{
    ...
    #[Route('/salle/{id}/edit', name: 'app_admin_salle_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/salle/{id}', name: 'admin_salle_delete', methods: ['POST'])]
    public function deleteSalle(Request $request, Salle $salle, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$salle->getIdSalle(), $request->request->get('_token'))) {
            // Supprimer l'image associée
            if ($salle->getImageSalle()) {
                $imagePath = $this->getParameter('salles_directory').'/'.$salle->getImageSalle();
