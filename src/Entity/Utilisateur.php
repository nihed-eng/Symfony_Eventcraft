...
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Length(min: 2, max: 50, minMessage: 'Your last name should be at least {{ limit }} characters', maxMessage: 'Your last name cannot be longer than {{ limit }} characters')]
    private ?string $nom = null;

    #[ORM\Column(length: 255, name: 'prenom')]
    #[Assert\NotBlank(message: 'Please enter your first name')]
    #[Assert\Length(min: 2, max: 50, minMessage: 'Your first name should be at least {{ limit }} characters', maxMessage: 'Your first name cannot be longer than {{ limit }} characters')]
